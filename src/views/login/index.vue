  ...
  <div class="login">
    <div class="login-left">
      <div
        class="title"
        :class="[
          ANIMATION_SWITCH ? 'animate__animated animate__fadeInLeft' : '',
        ]"
      >
    ...
    <div class="login-right">
      ...
      <div
        class="form"
        :class="[
          ANIMATION_SWITCH ? 'animate__animated animate__fadeInRight' : '',
        ]"
      >
        <el-form
          ref="ruleFormRef"
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" @click="submitForm(ruleFormRef)">
              {{ $t('msg.login.signInButton') }}
            </el-button>
          </el-form-item>
          <!-- 登录方式区域 -->
          <el-form-item class="login-method">
            <el-button :style="{ width: '34%' }">
              {{ $t('msg.login.mobileSignIn') }}
            </el-button>
            <el-button :style="{ width: '34%' }">
              {{ $t('msg.login.qrCodeSingIn') }}
            </el-button>
            <el-button :style="{ width: '24%' }">
          ...
          <el-form-item>
            <div class="other-login">
              <span
                >——————————————————————
                {{ $t('msg.login.signInWith') }} ——————————————————————</span
              >
            </div>
            <ul>
              <li>
                <a href=""><i class="r4 r4-github"></i></a>
              </li>
              <li>
                <a href=""><i class="r4 r4-weixin"></i></a>
              </li>
              <li>
                <a href=""><i class="r4 r4-alipay"></i></a>
              </li>
              <li>
                <a href=""><i class="r4 r4-gitee"></i></a>
              </li>
              <li>
                <a href=""><i class="r4 r4-twitter"></i></a>
              </li>
            </ul>
          </el-form-item>
        </el-form>
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate((valid, fields) => {
    if (valid) {
      if (ruleForm.name === 'admin' && ruleForm.password === '123456789') {
